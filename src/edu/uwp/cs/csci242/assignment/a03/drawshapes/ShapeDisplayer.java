...
public class ShapeDisplayer extends JFrame
{
    ...
    private class Board extends JComponent
    {
        ...
        /**
         * Converts a string color to a java.awt.Color. If the color is
         * not valid it returns gray.
         *
         * @param colorWord The string for the color
         * @return The java.awt.Color corresponding to the string.
         */
        private Color toColor(String colorWord) {
            Color FixedColors[] = { Color.BLUE, Color.GREEN,
                    Color.YELLOW, Color.RED, Color.LIGHT_GRAY, Color.WHITE };
        ...
        public void paintComponent(Graphics g) {
            ...
            for (int i = 0; (i < shapeList.size()); i++) {
                ...
                g.setColor(new Color(shapeColor.getRed(), shapeColor
                        .getGreen(), shapeColor.getBlue(), 200));
        ...
        /**
         * Creates the background. Makes the grid and sets the backgroun
         * to black.
         *
    ...
    public boolean contains(Shape newShape) {
        ...
        else if (newShape instanceof Hexagon) {
            return true;
        }
        else if (newShape instanceof Octagon) {
            return true;
        }
        else {
            return false;
